...
INPUT_SEQUENCES=Genomica/InputDatasets/AFS/SausageData/113003602_S4_forward_paired.fq
PARTITION_NUMBER=32
OUTPUT_DIR=Genomica/Output_113003602_S4_forward_$PARTITION_NUMBER
