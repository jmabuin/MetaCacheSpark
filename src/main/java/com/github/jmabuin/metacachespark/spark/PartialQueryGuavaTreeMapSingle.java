 ...
 */
public class PartialQueryGuavaTreeMapSingle implements Function<HashMultimap<Integer, LocationBasic>, TreeMap<LocationBasic, Integer>> {

    private static final Log LOG = LogFactory.getLog(PartialQueryGuavaTreeMapSingle.class);
    ...
    public PartialQueryGuavaTreeMapSingle(String file_name, long current_read, int result_size) {
    ...
    @Override
    public TreeMap<LocationBasic, Integer> call(HashMultimap<Integer, LocationBasic> myHashMap) {
            ...
            if (this.seqReader.next() != null) {
                ...
                for(Sketch currentSketch: locations) {
                    ...
                    for(int location: currentSketch.getFeatures()) {
                        ...
                        Set<LocationBasic> values = myHashMap.get(location);
