 ...
 */
public class PartialQueryNativeTreeMapSingle implements Function<HashMultiMapNative, TreeMap<LocationBasic, Integer>> {
    ...
    public PartialQueryNativeTreeMapSingle(String file_name, long current_read, int result_size) {
    ...
    @Override
    public TreeMap<LocationBasic, Integer> call(HashMultiMapNative myHashMap) {
            ...
            if (this.seqReader.next() != null) {
                ...
                for(Sketch currentSketch: locations) {
                    ...
                    for(int location: currentSketch.getFeatures()) {
                        ...
                        int[] values = myHashMap.get(location);
