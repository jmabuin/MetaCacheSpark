...
public class FastaSequenceReader2 implements FlatMapFunction<Tuple2<String, Text>, Sequence> {
    ...
    public FastaSequenceReader2(HashMap<String, Long> sequ2taxid, Build.build_info infoMode){
