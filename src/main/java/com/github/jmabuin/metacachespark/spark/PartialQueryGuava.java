 ...
 */
public class PartialQueryGuava implements PairFlatMapFunction<Iterator<HashMultimap<Integer, LocationBasic>>, Long, List<MatchCandidate>> {

    private static final Log LOG = LogFactory.getLog(PartialQueryGuava.class);
    ...
    public PartialQueryGuava(String file_name, long init, int bufferSize,long window_stride, MetaCacheOptions options){
