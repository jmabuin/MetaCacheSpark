 ...
 */
public class PartialQueryNativeMultiThreadPaired implements PairFlatMapFunction<Iterator<HashMultiMapNative>, Long, List<MatchCandidate>> {

    private static final Log LOG = LogFactory.getLog(PartialQueryNativeMultiThreadPaired.class);
    ...
    public PartialQueryNativeMultiThreadPaired(String file_name, String file_name2, long init, int bufferSize//) {
